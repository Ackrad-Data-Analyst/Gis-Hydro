...
for bank lines, cross sections, approved terrain notes, Manning's n/roughness notes,
flow and downstream boundary conditions, geometry review notes, HEC-RAS plan/geometry
notes, calibration/reasonableness notes, and the engineer/reviewer name before the run
...
8. **06 - Prepare Preliminary HEC-RAS Review Package:** export terrain and available vector
   ...
   all required HEC-RAS-ready fields and layers, it reports
