...
def _missing_model_inputs(
    ...
    input_requirements = {
        ...
        "downstream_boundary_condition", "geometry_review_notes", "model_plan_geometry",
        "calibration_or_reasonableness", "reviewer_name",
    }
    for name in required_names:
        if name in layer_requirements and name not in copied_layers:
            ...
            missing.append(name)
        elif name == "hydraulic_structures" and "crossings" not in copied_layers and "hydraulic_structures" not in copied_layers:
            missing.append(name)
    return missing
